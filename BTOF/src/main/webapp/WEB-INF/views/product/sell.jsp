...
<body>
	...
	<table width="700" align="center">
		...
		var popupY= (window.screen.height /2) - (300 / 2);
			function openBuy(){
				let url="/product/buy?prod_name=${product.prod_name}&prod_artist=${product.prod_artist}&prod_div=${product.prod_div}&prod_dtl_sn=${product.prod_dtl_sn}&prod_no=${product.prod_no}";
