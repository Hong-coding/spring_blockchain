    ...
    <div class="container">
      <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
        ...
        <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
          ...
          <li><a href="/common/marketplace" class="nav-link px-2 text-black">MARKETPLACE</a></li>
          <li><a href="/common/artist" class="nav-link px-2 text-black">ARTIST</a></li>
          <li><a href="/member/collection?prod_dtl_own=${nick}" class="nav-link px-2 text-black">MYNFT</a></li>
          <li><a href="/board/rank_pcs" class="nav-link px-2 text-black">RANKING</a></li>
          <li><a href="/board/" class="nav-link px-2 text-black">SUPPORT</a></li>
        </ul>
      </div>
    </div>
  </header>
		...
		<div class="admin_navi_wrap">
			<ul>
				<li><a class="admin_list_01" href="/member/mypage">마이
						페이지</a></li>
				<li><a class="admin_list_02" href="/member/mynft">마이 NFT</a>
				</li>
				<lI><a class="admin_list_03" href="/member/account">계좌
						등록</a></lI>
				<lI><a class="admin_list_04" href="/member/withdrawal">회원 탈퇴</a></lI>
				<li><a class="admin_list_05" href="/member/balance">충전</a></li>
			</ul>
		</div>
	</div>
